...
class App:
    ...
    def interpolate_lambda(self):
        ...
        lambda_lower = lambda_lower_lower + (lambda_lower_upper - lambda_lower_lower) * (self.W10 - w10_lower) / (
                    w10_upper - w10_lower)
        lambda_upper = lambda_upper_lower + (lambda_upper_upper - lambda_upper_lower) * (self.W10 - w10_lower) / (
                    w10_upper - w10_lower)
